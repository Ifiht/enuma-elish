...
case "$os" in
        ...
        linux)
                ...
                sudo apt install clang coreutils file findutils fortune-mod gcc geoip-database git gnupg gzip less lsb-base lsb-release lshw lsof make nano ncurses-base net-tools openjdk-8-jdk pngcrush rand readline-common screen tcpdump telnet xfsprogs zsh;
                os=2;
        ;;
        *Microsoft*)
